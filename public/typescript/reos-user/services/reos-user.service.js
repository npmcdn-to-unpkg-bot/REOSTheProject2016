System.register(['angular2/core'], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            REOSUserService = (function () {
                function REOSUserService() {
                    this.users = [
                ...
                REOSUserService.prototype.getUsers = function () {
                    return this.users;
                };
                ;
                REOSUserService = __decorate([
                    core_1.Injectable(), 
                    __metadata('design:paramtypes', [])
                ], REOSUserService);
                return REOSUserService;
            }());
            exports_1("REOSUserService", REOSUserService);
        }
    }
});
