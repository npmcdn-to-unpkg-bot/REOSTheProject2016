System.register(['angular2/core'], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            EduLessonService = (function () {
                function EduLessonService() {
                    this.lessons = [
                ...
                EduLessonService.prototype.getLessons = function () {
                    return this.lessons;
                };
                ;
                EduLessonService = __decorate([
                    core_1.Injectable(), 
                    __metadata('design:paramtypes', [])
                ], EduLessonService);
                return EduLessonService;
            }());
            exports_1("EduLessonService", EduLessonService);
        }
    }
});
